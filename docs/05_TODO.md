...
- [~] Add GraphQL and gRPC UI surfaces after REST parity is stable; current
  ...
  summaries wired and gRPC reflection plus unary transport still pending.
