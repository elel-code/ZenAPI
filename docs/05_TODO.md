...
| Area | Status | Notes |
|------|--------|-------|
| App shell | Multi-page Slint shell restored | Responsive resident page stack with deferred page rendering, lightweight read-only code blocks, global navigation, bottom compact navigation, status bar, and overflow scrollbars |
