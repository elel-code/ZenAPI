...
- [~] Split reusable controls from `ui/app.slint` into dedicated Slint modules;
  ...
  Request panel, Request tab strip, Request tab content, Response panel,
  Response header strip, Response tab strip, Response toolbar, Response viewer,
  Sidebar, App navigation, Address bar,
  ...
  Mock Manager page, Mock Manager row components, Mock Manager rules panel, Mock
