...
| Area | Status | Notes |
|------|--------|-------|
| App shell | Multi-page Slint shell restored | Responsive resident page stack with deferred page rendering, global navigation, bottom compact navigation, status bar, and overflow scrollbars |
