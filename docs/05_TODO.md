...
- [~] Rebuild Collections UI for native JSON/Postman import/export, saving
  ...
  sidebar list with imported folder rows visible, including pre-request/tests
  text, and duplicates/deletes saved requests, with request rename wired and
  folder creation/reparenting plus drag/drop still pending.
...
| Collections | Domain implemented | Slint baseline supports load/save/export, folder row display, and request restore/rename/duplicate/delete |
