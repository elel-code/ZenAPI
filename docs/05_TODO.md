...
- [~] Split reusable controls from `ui/app.slint` into `ui/widgets/`; current
  ...
  business panel, Request panel, Response panel, Sidebar, App navigation,
  Address bar, Dashboard page, Codegen page, Settings page, Team page, API Keys
  page, Analytics page, Documentation page, Environment page, Runner page, and
  Mock Manager page now live in dedicated Slint files; additional large panels
...
| Area | Status | Notes |
|------|--------|-------|
| App shell | Multi-page Slint shell restored | Responsive persistent page mounting with visibility switching, lightweight read-only code blocks, global navigation, compact navigation, request-sidebar OpenAPI import, and overflow scrollbars |
